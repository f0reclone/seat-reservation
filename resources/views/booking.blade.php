...
@section('content')
    ...
    <p class="pt-8 text-sm">Bitte melden Sie sich an und bringen, damit wir die Kapazitäten planen können.</p>
    <div class="mt-5">
        <form action="{{ route('booking.post') }}" method="POST">
            @csrf
            <div class="mt-4">
                <label for="date_id"
                       class="block text-base font-medium leading-5 text-gray-700">Termin</label>
            ...
            <div class="mt-4">
                <label for="quantity"
                       class="block text-base font-medium leading-5 text-gray-700">Anzahl Personen</label>
            ...
            <div class="mt-4">
                <label for="name" class="block text-base font-medium leading-5 text-gray-700">Name</label>
            ...
            <div class="mt-4">
                <label for="email"
                       class="block text-base font-medium leading-5 text-gray-700">E-Mail</label>
            ...
            <div class="mt-4">
                <label for="phone"
                       class="block text-base font-medium leading-5 text-gray-700">Telefon</label>
