...
@section('scripts')
                ...
                <div class="mt-4 mb-8 as-element-dark">
                    ...
                    <ul class=" grid grid-cols-2 pt-8 text-md text-3xl  ">
                        <li class="col-start-1 m-4 md:m-2 border-l-2 border-r-2 as-border p-4 handwriting">
                            <div class="text-5xl">19.12.</div>
                            um 18 Uhr
                        </li>
                        <li class="col-start-2 m-4 md:m-2 border-l-2 border-r-2 as-border  p-4 handwriting">
